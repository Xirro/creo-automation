...
reqPromise(connectOptions)
    ...
    .catch(err => {
        ...
        if (err.cause && err.cause.code === 'ECONNREFUSED') {
            console.log('> Error in pdfDxfBinBomController.js: Creoson server is not running or not reachable at http://localhost:9056/creoson');
        } else {
            console.log('> There was an error in pdfDxfBinBomController.js: ', err);
        }
    });
